                            ...
                            @foreach ($userdata as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/user/' . $data->id) }}"
                                            class="btn btn-warning btn-xs btn-edit" id="edit" style="color: white;"><i
                                                class="menu-icon fa fa-pencil"></i> Edit</a>
                                        <a href="javascript:void(0)" id="deletebtn" class="btn btn-danger btn-xs btn-hapus"
                                            data-id="{{ $data->id }}"><i class="fa fa-trash-o"></i> Hapus </a>
                                    </td>
                                </tr>
