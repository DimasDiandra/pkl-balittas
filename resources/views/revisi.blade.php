                    ...
                    <div class="card shadow h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div style="position: absolute; bottom: 16px;">
                                <button type="submit" class="btn btn-primary upload"><i class="menu-icon fa fa-upload"></i>
                                    Upload</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item">
                            <a class="nav-link active" href="#semula_menjadi" role="tab" data-toggle="tab">FM Semula
                                Menjadi</a>
                        </li>
                        <li class="nav-item">
